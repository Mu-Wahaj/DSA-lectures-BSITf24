...
void sortStack(Stack &s)
{
    ...
    {
        int val = s.pop();//firt or maxximum element beacouse we need some value to comapre to the other values 
...
int main()
{
    ...
    cout << endl
         << "Reverse first K elements of queue demo" << endl;
    Queue q2;
